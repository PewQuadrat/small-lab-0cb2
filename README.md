...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/small-lab-0cb2)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/small-lab-0cb2
```

A live public deployment of this template is available at [https://small-lab-0cb2.templates.workers.dev](https://small-lab-0cb2.templates.workers.dev)
